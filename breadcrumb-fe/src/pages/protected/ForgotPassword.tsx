      ...
      <div>
        <main className="flex min-h-screen flex-col items-center justify-center p-24">
          ...
          <div className="relative place-items-center">
            <div className="mt-2">
              <p className="text-sm text-black-500">What is your username</p>
              <div>
                <div className="relative mt-2 rounded-md shadow-sm">
                  <input
                    ...
                    className="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-black-900 ring-1 ring-inset ring-black-300 placeholder:text-black-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div className="mt-2">
                <p className="text-sm text-black-500">What is your code</p>
                <div>
                  <div className="relative mt-2 rounded-md shadow-sm">
                    <input
                      type="text"
